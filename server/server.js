  ...
  try {
    ...
    try {
      ...
      const seedMovies = [
        ...
        // Ensure presence across categories
        { title: 'The Mask', year: 1994, genre: 'Comedy', director: 'Chuck Russell', plot: 'A bank clerk transforms into a manic superhero when he wears a mysterious mask.', posterUrl: 'https://m.media-amazon.com/images/I/51dWg3imZDL._AC_.jpg' },
        { title: 'The Lord of the Rings: The Fellowship of the Ring', year: 2001, genre: 'Fantasy', director: 'Peter Jackson', plot: 'A hobbit embarks on a quest to destroy a powerful ring.', posterUrl: 'https://m.media-amazon.com/images/I/51Qvs9i5a+L._AC_.jpg' },
        { title: 'The Conjuring', year: 2013, genre: 'Horror', director: 'James Wan', plot: 'Paranormal investigators help a family terrorized by a dark presence.', posterUrl: 'https://m.media-amazon.com/images/I/71vQ8iGxFHL._AC_SL1200_.jpg' },
        { title: 'La La Land', year: 2016, genre: 'Romance', director: 'Damien Chazelle', plot: 'A jazz pianist and an aspiring actress fall in love while pursuing their dreams.', posterUrl: 'https://pics.filmaffinity.com/la_la_land-262021831-large.jpg' },
        { title: 'Free Solo', year: 2018, genre: 'Documentary', director: 'Elizabeth Chai Vasarhelyi & Jimmy Chin', plot: 'Alex Honnold attempts to free solo climb El Capitan.', posterUrl: 'https://www.rollingstone.com/wp-content/uploads/2018/09/FreeSolo_alex-honnold.jpg' },
        { title: 'Toy Story', year: 1995, genre: 'Kids', director: 'John Lasseter', plot: 'A cowboy doll is threatened by the arrival of a space ranger action figure.', posterUrl: 'https://lumiere-a.akamaihd.net/v1/images/p_toystory_19639_424d94a0.jpeg' },
        { title: 'Knives Out', year: 2019, genre: 'Mystery', director: 'Rian Johnson', plot: 'A detective investigates the death of a patriarch of an eccentric family.', posterUrl: 'https://lionsgate.brightspotcdn.com/8c/df/60bb91a646afbfb17661729b3c43/knivesout-titlepage-background.jpg' },
        { title: 'Spirited Away', year: 2001, genre: 'Anime', director: 'Hayao Miyazaki', plot: 'A young girl enters a world of spirits and must find a way back.', posterUrl: 'http://images5.fanpop.com/image/photos/29000000/Spirited-Away-spirited-away-29095841-1024-768.jpg' }
      ];
      ...
      const defaultPostersByGenre = {
        'Action': 'https://m.media-amazon.com/images/I/51K8ouYrHeL._AC_.jpg',
        'Action / Drama': 'https://m.media-amazon.com/images/M/MV5BYWQ4YmNjYjEtOWE1Zi00Y2U4LWI4NTAtMTU0MjkxNWQ1ZmJiXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg',
        'Action / Sci-Fi': 'https://images-na.ssl-images-amazon.com/images/I/A1aHRPvn5JL._RI_.jpg',
        'Drama': 'https://m.media-amazon.com/images/I/519NBNHX5BL._AC_.jpg',
        'Drama / Romance': 'https://originalvintagemovieposters.com/wp-content/uploads/2020/02/TITANIC-8567-scaled.jpg',
        'Crime': 'https://m.media-amazon.com/images/I/41+eK8zBwQL._AC_.jpg',
        'Thriller': 'https://m.media-amazon.com/images/I/71c05lTE03L._AC_SL1024_.jpg',
        'Comedy': 'https://m.media-amazon.com/images/I/51dWg3imZDL._AC_.jpg',
        'Fantasy': 'https://m.media-amazon.com/images/I/51Qvs9i5a+L._AC_.jpg',
        'Horror': 'https://m.media-amazon.com/images/I/71vQ8iGxFHL._AC_SL1200_.jpg',
        'Romance': 'https://m.media-amazon.com/images/I/81MZr0i2tOL._AC_SL1500_.jpg',
        'Documentary': 'https://m.media-amazon.com/images/I/71+3t8i8H0L._AC_SL1500_.jpg',
        'Kids': 'https://m.media-amazon.com/images/I/51B0QK5N7YL._AC_.jpg',
        'Mystery': 'https://m.media-amazon.com/images/I/81bA+z1Vq3L._AC_SL1500_.jpg',
        'Mystery / Drama': 'https://c8.alamy.com/comp/DT67F9/hugh-jackman-scarlett-johansson-christian-bale-poster-the-prestige-DT67F9.jpg',
        'Sci-Fi': 'https://m.media-amazon.com/images/I/51zUbui+gbL._AC_.jpg',
        'Sci-Fi / Adventure': 'https://m.media-amazon.com/images/I/81QYVQxH7lL._AC_SL1500_.jpg',
        'Biography / Drama': 'https://images.wallpapersden.com/image/download/oppenheimer-2023-movie-poster_bmVpamqUmZqaraWkpJRmZ2dprWZnZ2k.jpg',
        'Biography / Comedy': 'http://www.danielyeow.com/wp-content/uploads/TheWolfofWallStreet-poster.jpg',
        'Anime': 'https://m.media-amazon.com/images/I/71tZK3z0RgL._AC_SL1200_.jpg'
      };
      const fallbackPoster = 'https://via.placeholder.com/300x450?text=Movie';
